...
#Create function for var to snakecase

\#`{r} #metabolite_values_to_snakecase <- function(data) { #  data %>%  #    dplyr::mutate(metabolite = snakecase::to_snake_case(metabolite)) #} #lipidomics %>%  #  metabolite_values_to_snakecase() #`
